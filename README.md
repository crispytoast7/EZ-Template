...
> **status: main branch, on pros kernel 4.2.2.** boots fully in an emulator (with the black-screen kernel bugs fixed here); real-robot testing happens when i'm back at school. treat every feature as unverified on hardware until it's checked off below.
